    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (unStrippedState.isPresent()) {
            ...
            if (playerEntity != null && !playerEntity.isCreative()) {
                // 1.21 handles the break animation/sound itself, the old break callback is gone
                playerEntity.getStackInHand(context.getHand()).damage(5, playerEntity, LivingEntity.getSlotForHand(context.getHand()));
            }

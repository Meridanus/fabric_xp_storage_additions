...
public final class XpsAdditionsNeoForgeClient {
    ...
    /**
     * The screens have to be registered here rather than through architectury's
     ...
     * filled, so the menu types resolve.
     */
    public static void onRegisterMenuScreens(RegisterMenuScreensEvent event) {
        event.register(AdditionMenus.BOX_SCREEN_HANDLER.get(), PositionedScreen::new);
        event.register(AdditionMenus.XP_ENCHANTER_SCREEN_HANDLER.get(), XpEnchanterScreen::new);
    }
}
